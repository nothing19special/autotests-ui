...
@pytest.mark.courses
@pytest.mark.regression
def test_create_course(create_course_page: Page, courses_list_page: Page):
    ...
    create_course_page.upload_preview_image('./testdata/files/15745135259_7d4dbff3bb_o.jpg')
